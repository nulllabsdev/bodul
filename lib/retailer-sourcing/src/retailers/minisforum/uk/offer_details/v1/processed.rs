...
use super::destructured::{
    MinisForumUkAvailability, MinisForumUkDestructuredProduct, MinisForumUkFeature, MinisForumUkMetaVariant,
    MinisForumUkOffer, MinisForumUkXcottonProduct, MinisForumUkXcottonVariant,
};
