...
//! the JSON-LD blocks and the OpenGraph head meta.  Layout identical to EU
//! except the footer uses a `<section class="Footer_footer_layer__UWeiq">`
...
pub fn offer_detail_architecture_v1() -> RetailerArchitecture {
    RetailerArchitecture::new(vec![
        ...
        // Client-rendered sidebar menu shell.
