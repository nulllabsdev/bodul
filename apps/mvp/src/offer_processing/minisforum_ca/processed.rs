...
use super::destructured::{
    MinisForumCaAvailability, MinisForumCaDestructuredProduct, MinisForumCaFeature,
    MinisForumCaMetaVariant, MinisForumCaOffer, MinisForumCaProduct, MinisForumCaProductVariant,
};
