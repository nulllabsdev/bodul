...
| 0002 | 2026-01-13 | Architecture  | Programming languages              | Proposed | @miro  | @miro    | docs/technical/decisions/EDR-0002-rust-programming-language.md       | Rust primary, Go secondary for prototypes and tooling              |
| 0003 | 2026-01-13 | Architecture  | PostgreSQL as primary database     | Proposed | @miro  | @miro    | docs/technical/decisions/EDR-0003-postgresql-data-storage.md         | PostgreSQL for ACID compliance, PostGIS, and full-text search      |
| 0004 | 2026-01-13 | Architecture  | Monorepo with layered architecture | Proposed | @miro  | @miro    | docs/technical/decisions/EDR-0004-monorepo-architecture.md           | Monorepo with lib/, shared/, and layered app structure             |
