...
| 0005 | 2026-01-13 | DevExp        | Makefile as task runner            | Proposed | @miro  | @miro    | docs/technical/decisions/EDR-0005-makefile-task-runner.md            | All tasks defined via Makefile for consistency                     |
