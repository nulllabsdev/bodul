...
| 0005 | 2026-01-13 | DevExp        | Makefile as task runner            | Accepted | @miro  | @miro    | docs/technical/decisions/EDR-0005-makefile-task-runner.md            | All tasks defined via Makefile for consistency                     |
| 0006 | 2026-01-14 | Security      | Internal service security          | Accepted | @miro  | @miro    | docs/technical/decisions/EDR-0006-internal-service-security.md       | Auth client with hardcoded credentials, no central service         |
